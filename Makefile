...
stories.fo: SearchRequest.xml cards.xsl descriptions.timestamp
...
stories-alt.fo: SearchRequest.xml cards-alt-layout.xsl descriptions.timestamp
	saxonb-xslt -ext:on -o:stories-alt.fo -s:SearchRequest.xml -xsl:cards-alt-layout.xsl
descriptions.timestamp: SearchRequest.xml cards.xsl
